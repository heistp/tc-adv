...
/*
 * Lightweight Fair Queueing with Codel-BLUE Alternate - lfq-COBALT
 *
...
static struct lfq_preset presets[] = {
	{"datacentre",		5,		100},
	{"lan",			50,		1000},
	{"metro",		500,		10000},
	{"regional",		1500,		30000},
...
static struct lfq_preset *find_preset(char *argv)
{
	int i;
...
{
	fprintf(stderr,
"Usage: ... lfq_cobalt [ bandwidth RATE | unlimited* ]\n"
...
static int lfq_parse_opt(struct qdisc_util *qu, int argc, char **argv,
			  struct nlmsghdr *n, const char *dev)
{
	struct lfq_preset *preset, *preset_set = NULL;
...
static void lfq_print_mode(unsigned int value, unsigned int max,
...
static int lfq_print_opt(struct qdisc_util *qu, FILE *f, struct rtattr *opt)
{
...
static int lfq_print_xstats(struct qdisc_util *qu, FILE *f,
			     struct rtattr *xstats)
{
	return 0;
}

struct qdisc_util lfq_cobalt_qdisc_util = {
	.id		= "lfq_cobalt",
	.parse_qopt	= lfq_parse_opt,
	.print_qopt	= lfq_print_opt,
	.print_xstats	= lfq_print_xstats,
};
